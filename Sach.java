...
public Sach(String maSach, String tuaSach, String tacGia, int namXB, String nhaXB, int soTrang, double donGia, String isbn) { 
	this.maSach = maSach;
...
public void setTacGia(String tacGia) {
	...
	public void setSoTrang(int soLuong) { this.soTrang = soLuong;
	}
	...
	public int hashCode() {
		final int prime = 31; 
		int result = 1;
		result = prime * result + ((maSach == null)? 0 :
				maSach.hashCode());
		return result;
	}
	...
	if (maSach == null) {
		if (other.maSach != null)
			return false;
			} else if (!maSach.equalsIgnoreCase(other.maSach)) return false;
			return true;
			}
